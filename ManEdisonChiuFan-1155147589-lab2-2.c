...
void handle_lui(unsigned int cur_inst) {
    ...
    int imm12 = sext(MASK31_12(cur_inst),12);
    NEXT_LATCHES.REGS[rd] = imm12 << 12;
}
...
void handle_jalr(unsigned int cur_inst) {
     ...
     */
    unsigned int rd = MASK11_7(cur_inst),rs1=MASK19_15(cur_inst);
    int imm20= MASK31_20(cur_inst);
    NEXT_LATCHES.PC = CURRENT_LATCHES.REGS[rs1] + sext(imm20,11);
...
void handle_lh(unsigned int cur_inst) {
    ...
    unsigned int rd = MASK11_7(cur_inst), rs1 = MASK19_15(cur_inst);
    int imm12 = MASK31_20(cur_inst);
    int x=(MEMORY[sext(imm12, 12) + CURRENT_LATCHES.REGS[rs1]+1]);
    int y=MASK7_0(MEMORY[sext(imm12, 12) + CURRENT_LATCHES.REGS[rs1]]);
        NEXT_LATCHES.REGS[rd] =sext((x<<8)+y,16);
}
...
void handle_lw(unsigned int cur_inst) {
    ...
    unsigned int rd = MASK11_7(cur_inst), rs1 = MASK19_15(cur_inst);
    int imm12 = MASK31_20(cur_inst);
    int w=(MEMORY[sext(imm12, 12) + CURRENT_LATCHES.REGS[rs1]+3]);
    int x=(MEMORY[sext(imm12, 12) + CURRENT_LATCHES.REGS[rs1]+2]);
    int y=(MEMORY[sext(imm12, 12) + CURRENT_LATCHES.REGS[rs1]+1]);
    int z=MASK7_0(MEMORY[sext(imm12, 12) + CURRENT_LATCHES.REGS[rs1]]);
    NEXT_LATCHES.REGS[rd] =(w<<24)+(x<<16)+(y<<8)+z;
}
...
void handle_sb(unsigned int cur_inst) {
    ...
    int imm12 = (MASK31_25(cur_inst) << 5) + \
            (MASK11_7(cur_inst));
    MEMORY[sext(imm12, 12) + CURRENT_LATCHES.REGS[rs1]]=MASK7_0(CURRENT_LATCHES.REGS[rs2]);
}
...
void handle_sh(unsigned int cur_inst) {
    ...
    int imm12 = (MASK31_25(cur_inst) << 5) + \
            (MASK11_7(cur_inst));
    int a=MASK15_8(CURRENT_LATCHES.REGS[rs2]);
    int b=MASK7_0(CURRENT_LATCHES.REGS[rs2]);
    MEMORY[sext(imm12, 12) + CURRENT_LATCHES.REGS[rs1]+1]=a;
    MEMORY[sext(imm12, 12) + CURRENT_LATCHES.REGS[rs1]]=b;
}
...
void handle_sw(unsigned int cur_inst) {
    ...
    int imm12 = (MASK31_25(cur_inst) << 5) + \
            (MASK11_7(cur_inst));
    int w=MASK31_24(CURRENT_LATCHES.REGS[rs2]);
    int x=MASK23_16(CURRENT_LATCHES.REGS[rs2]);
    int y=MASK15_8(CURRENT_LATCHES.REGS[rs2]);
    int z=MASK7_0(CURRENT_LATCHES.REGS[rs2]);
    MEMORY[sext(imm12, 12) + CURRENT_LATCHES.REGS[rs1]+3]=w;
    MEMORY[sext(imm12, 12) + CURRENT_LATCHES.REGS[rs1]+2]=x;
    MEMORY[sext(imm12, 12) + CURRENT_LATCHES.REGS[rs1]+1]=y;
    MEMORY[sext(imm12, 12) + CURRENT_LATCHES.REGS[rs1]]=z;
